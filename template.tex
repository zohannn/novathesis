...
\addlisttofrontmatter{\listofalgorithms}  % The List of Algorithms. Comment to omit.
%\pdfbookmark[1]{\listalgorithmname}{loa} % Bookmark the list of algorithms to the PDF
